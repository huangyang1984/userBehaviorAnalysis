...
<body>
<form id="slopeOneComputer" name="slopeOneComputer" method="post" action="userCf.do?method=computerWithUserCf" onsubmit="return check()">
      ...
      <td valign="top" class="SearchForm">
		  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="SearchTable">
	        <tr>
		  	  <td class="SearchTableLabel">客户号:<input type="text" name="userId" id="userId" /></td>
